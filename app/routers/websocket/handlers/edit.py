# app/routers/websocket/handlers/edit.py

import time

from ..conn_manager import manager, broadcast_message_to_room
from ..models import WSResponseBase, WSEditMessageRequest
...
async def handle_edit_request(
    ...
    await broadcast_message_to_room(
        db=db, room_id=data.room_id, message=message, action="broadcast:edit", exclude_session=session_id
    )
